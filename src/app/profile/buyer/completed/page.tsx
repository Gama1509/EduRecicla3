...
function ProductViewPage() {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const res = await api.get<TransactionsProfileDto[]>(`/transactions/getCompletedTransactionsByBuyer`);
        ...
        <div className="p-6 w-full overflow-x-auto">
            <div className="flex flex-col items-center mb-8 gap-6">
                <h1 className="text-3xl font-bold text-text-primary-light dark:text-text-primary-dark text-center">
                    Transaccciones completadas conmigo como comprador (ya marque de recibido)
                </h1>
                {loading && (
