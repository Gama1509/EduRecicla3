...
import { confirmDeliveryAction, handleAcceptInterest, handleRejectInterest } from "@/app/notifications/views/NotificationViews";
...
function ProductViewPage() {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const res = await api.get<TransactionsProfileInProgressDto[]>(`/transactions/getTransactionsDeliveredByBuyer`);
        ...
        <div className="p-6 w-full overflow-x-auto">
            ...
            <div className="flex flex-col items-center mb-8 gap-6">
                ...
                <h1 className="text-3xl font-bold text-text-primary-light dark:text-text-primary-dark text-center">
                    Transaccciones donde ya recibi el producto
                </h1>
                                ...
                                <thead>
                                    <tr className="border-b border-border-light dark:border-border-dark">
                                        {[
                                            ...
                                            <th
                                                key={header}
                                                className={`py-2 px-4 text-center align-middle whitespace-nowrap text-text-primary-light dark:text-text-primary-dark
