...
function ProductViewPage() {
    ...
    useEffect(() => {
        const fetchTransactions = async () => {
            try {
                const res = await api.get<TransactionsProfileDto[]>(`/transactions/getCancelledTransactionsBySeller`);
        ...
        <div className="p-6 w-full overflow-x-auto">
            <div className="flex flex-col items-center mb-8 gap-6">
                <h1 className="text-3xl font-bold text-text-primary-light dark:text-text-primary-dark text-center">
                    Transaccciones que cancele cuando estaban en proceso
                </h1>
                {loading && (
                                    ...
                                    {filteredTransactions.map((transaction) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">
                                                ...
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">{transaction.product}</td>
                                                <td className="py-2 px-4 border-r text-center align-middle">{transaction.quantityRequested}</td>
                                                <td className="py-2 px-4 border-r text-center align-middle">{transaction.requestReason ?? "No incluyo razón"}</td>
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">{statusLabels[transaction.transaction_status]}</td>
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">{transaction.createdAt}</td>
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">{transaction.updatedAt}</td>
                                                ...
                                                <td className="py-2 px-4 border-r text-center align-middle whitespace-nowrap">
                                                    {transaction.cancelReason ?? "No incluyo razón"}
                                                </td>
