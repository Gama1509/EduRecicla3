...
export default function ProductViewPage() {
    ...
    const handleCancelTransactionBuyer = async (transactionId: string) => {
        // Confirmación inicial
        const confirmResult = await Swal.fire({
            title: "Cancelar transacción",
            text: "¿Seguro que deseas cancelar esta transacción en progreso? Al comprador se le aplicará una sanción de 15 días donde no podrá volver a interesarse en este producto.",
            icon: "warning",
