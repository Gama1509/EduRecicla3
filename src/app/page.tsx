  ...
  return (
    <div>
      ...
      <section className="text-center py-20">
        <h1 className="text-5xl font-bold text-secondary">Welcome to EduRecicla</h1>
        <p className="text-xl text-gray-600 mt-4">
          Your one-stop platform for buying, selling, and donating recycled tech for students in need.
        </p>
        <div className="mt-8">
          <Link href="/buy" className="bg-secondary text-white font-bold py-3 px-6 rounded-lg hover:bg-secondary-600 transition-colors">
            Explore Catalog
          </Link>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-8 text-center">
          <div className="p-8 border rounded-lg shadow-md">
            <h3 className="text-2xl font-semibold text-primary">1. Donate or Sell</h3>
            <p className="mt-2 text-gray-600">
              Easily list your used tech equipment for donation or sale. Give your devices a second life and help a student.
            </p>
          </div>
          <div className="p-8 border rounded-lg shadow-md">
            <h3 className="text-2xl font-semibold text-secondary">2. We Refurbish</h3>
            <p className="mt-2 text-gray-600">
              Our team ensures every device is in good working condition, ready for its new owner.
            </p>
          </div>
          <div className="p-8 border rounded-lg shadow-md">
            <h3 className="text-2xl font-semibold text-secondary">3. Students Benefit</h3>
            <p className="mt-2 text-gray-600">
      ...
      <section className="py-20 text-center">
        ...
        <div className="mt-8">
          <Link href="/donate" className="bg-primary text-white font-bold py-3 px-6 rounded-lg hover:bg-primary-600 transition-colors">
            Donate Now
          </Link>
        </div>
      </section>
