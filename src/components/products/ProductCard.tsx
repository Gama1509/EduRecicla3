...
const ProductCard = ({ product }: ProductCardProps) => {
  return (
    <Link href={`/buy/${product.id}`}>
      <div className="border border-border-light dark:border-border-dark bg-card-light dark:bg-card-dark rounded-lg shadow-md overflow-hidden transition-transform transform hover:-translate-y-1 h-full flex flex-col">
        <Image
        ...
        <div className="p-4 flex flex-col flex-grow">
          <h3 className="text-lg font-semibold text-text-primary-light dark:text-text-primary-dark">{product.name}</h3>
